package com.lihecen.xiaohongshu.auth.runner;
...
import com.lihecen.xiaohongshu.auth.domain.mapper.PermissionDOMapper;
import com.lihecen.xiaohongshu.auth.domain.mapper.RoleDOMapper;
import com.lihecen.xiaohongshu.auth.domain.mapper.RolePermissionDOMapper;
...
public class PushRolePermissions2RedisRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        try {
            // 是否能够同步数据: 原子操作, 只有在键 PUSH＿PERMISSION_FLAG 不存在时, 才会设置该键的值为 1, 并设置过期时间为 1 天
